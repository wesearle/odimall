CREATE DATABASE IF NOT EXISTS odimall;
USE odimall;
...
(1, 50), (2, 35), (3, 25), (4, 60), (5, 15),
(6, 10), (7, 40), (8, 100), (9, 75), (10, 80);

CREATE USER IF NOT EXISTS 'odimall'@'%' IDENTIFIED BY 'odimall123';
GRANT ALL PRIVILEGES ON odimall.* TO 'odimall'@'%';
FLUSH PRIVILEGES;
